...
class MissionAreaPage3 extends StatelessWidget {
  MissionAreaPage3({super.key});
...
11 May
  2022''',
                                ...
                                ListTile(
                                  title: Text(
                                    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Congue lorem duis sollicitudin quis vitae nunc. Odio quis ut bibendum egestas tristique porttitor sed. Tempus senectus volutpat volutpat, cras ultricies. Scelerisque integer cursus auctor integer tempus",
                                    style: TextStyle(
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(
                                      left: 60, right: 60),
                                  child: GreyButton(
                                      greyButtonText: "No more acception.",
                                      greybuttonAction: () {
                                        Navigator.pop(context);
                                      }),
                                ),
