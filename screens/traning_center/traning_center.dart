...
import 'package:wamfo/screens/traning_center/traning_center_vm.dart';
import 'package:wamfo/screens/traning_center/view_character/view_character.dart';

class TraningCenterHome extends StatefulWidget {
  const TraningCenterHome({Key? key}) : super(key: key);

  @override
  State<TraningCenterHome> createState() => _TraningCenterHomeState();
}

class _TraningCenterHomeState extends State<TraningCenterHome>
    with BasePage<TraningCenterHomeVM> {
                        ...
                        child: Stack(
                          children: [
                            SizedBox(
                              height: height,
                              child: Image.asset(
                                'assets/common/traning_center_bg.png',
                                fit: BoxFit.cover,
                              ),
                            ),
                            Positioned(
                              ...
                              child: const CustomButton1(
                                  text: "Train your character"),
                            ),
                            Positioned(
                              top: height * 0.75,
                              left: width * 1.1,
                              child:
                                  const CustomButton1(text: "Check your Gear"),
                            ),
                            Positioned(
                              top: height * 0.57,
                              left: width * 2.2,
  ...
  @override
  TraningCenterHomeVM create() => TraningCenterHomeVM();
